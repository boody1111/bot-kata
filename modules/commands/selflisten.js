...
module.exports.run = async function({ api, event, args, client }) {
    ...
    try {
        ...
        if (args[0] === "on") {
            ...
            return api.sendMessage("يرجى sử dụng: #sl on/off", event.threadID, event.messageID);
        }
        ...
        return api.sendMessage("حدث خطأ khi cập nhật cấu hình.", event.threadID, event.messageID);
    }
};
