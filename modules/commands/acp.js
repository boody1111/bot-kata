...
module.exports.handleReply = async ({ handleReply, event, api }) => {
  ...
  else return api.sendMessage("يرجى chọn <add | del > <số thứ tự | hoặc \"all\">", event.threadID, event.messageID);
  ...
  for (const stt of targetIDs) {
    ...
    if (!u) {
      failed.push(`لم يتم العثور على stt ${stt} trong danh sách`);
      continue;
    }
