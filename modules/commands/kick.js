module.exports.config = {
    ...
    description: "طرد عضو من المجموعة عن طريق التاق أو الرد",
        ...
        if (args.join().indexOf('@') !== -1) {
            ...
            for (let o of mention) {
                if (o !== protectedUID) {
                    ...
                    api.sendMessage(`لا يمكن طرد المستخدم ذو UID: ${protectedUID}`, threadID, messageID);
                }
            }
            ...
            if (uid !== protectedUID) {
                ...
                return api.sendMessage(`لا يمكن طرد المستخدم ذو UID: ${protectedUID}`, threadID, messageID);
            }
        } else if (args[0] == "all") {
            ...
            return api.sendMessage(`يرجى tag, reply người muốn kick, hoặc dùng "kick all" để rã box.`, threadID, messageID);
        }
    } catch {
...
module.exports.handleReply = async function ({
    ...
    if (body.toLowerCase() === "có") {
        ...
        return api.sendMessage("يرجى reply với \"có\" hoặc \"không\" để xác nhận.", threadID, messageID);
    }
};
